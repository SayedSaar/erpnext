...
def execute(filters=None):
	...
	if filters.party_type == "Customer" and filters.party:
		address_name = get_default_address(filters.party_type, filters.party)
		if address_name:
			address = get_address_display(address_name)
		
		contact_name = get_default_contact(filters.party_type, filters.party)
		if contact_name:
			contact_details = get_contact_details(contact_name)
			mobile = contact_details["contact_mobile"]

	return columns, res, [], [], [ address, mobile ]
